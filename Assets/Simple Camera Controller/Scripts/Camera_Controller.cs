...
public class Camera_Controller : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        // Mouse_Location = new Vector3(Mouse.current.position.ReadValue().x, Mouse.current.position.ReadValue().y, 0) - Mouse_Location;
        //
        ...
        //
        // Mouse_Location = Mouse.current.position.ReadValue();
    ...
    private Vector3 GetBaseInput()
    {
        ...
        float VerticalInput = Keyboard.current.upArrowKey.isPressed ? 1f : Keyboard.current.downArrowKey.isPressed ? -1 : 0; //Input for horizontal movement
        
        float HorizontalInput  = Keyboard.current.rightArrowKey.isPressed ? 1f : Keyboard.current.leftArrowKey.isPressed ? -1 : 0; //Input for Vertical movement
